...
export const registrationSchema = z.object({
  ...
  organization: z.string().min(2, 'Veuillez indiquer votre organisation'),
  job_title: z.string().min(2, 'Veuillez indiquer votre fonction'),
  participant_type: z.enum(['visitor', 'press', 'exposant_msme', 'paneliste'] as const, {
